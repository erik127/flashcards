 <template>
  <div class='settings'>
    ...
    <label for='presReg'>Verbs</label><br>
    <input type='button' value='OK' @click='$emit("change",settings)'>
